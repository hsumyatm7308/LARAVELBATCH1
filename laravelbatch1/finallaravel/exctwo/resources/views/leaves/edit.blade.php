                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0"
                                placeholder="Enter your Title name" value="{{$leave->title}}" />
                        </div>
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <textarea name="content" id="content" class="form-control form-control-lg rounded-0"
                                rows="5" placeholder="Say Something...">{{$leave->content}}</textarea>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <select name="tag" id="tag" class="form-control form-control-sm rounded">
                                ...
                                @foreach($tags as $tag)
                                <option value="{{$tag->id}}" @if($tag['id']===$leave['tag']) selected @endif>
                                    {{$tag->name}}</option>
                                @endforeach
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <select name="post_id" id="post_id" class="form-control form-control-sm rounded">
                                ...
                                <option value="{{$post->id}}" @if($post['id']===$leave['post_id']) selected @endif>
                                    {{$post->title}}</option>
                                @endforeach
