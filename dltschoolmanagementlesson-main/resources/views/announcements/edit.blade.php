                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="image" id="image" class="form-control form-control-sm rounded-0" value="{{old('image',$announcement->image)}}" hidden />
                                </div>
                            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" placeholder="Enter Post Title" value="{{old('title',$announcement->title)}}" />
                                {{-- @error('title')
