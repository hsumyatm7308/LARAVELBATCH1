...
@section('scripts')
    ...
    getfilterstatus.addEventListener('click',function(){
            ...
            // console.log(getcururl); // http://localhost:8000/roles?filterstatus_id=3
            // console.log(getcururl.split('?')); // ['http://localhost:8000/roles', 'filterstatus_id=3']
            // console.log(getcururl.split('?')[0]); // http://localhost:8000/roles
