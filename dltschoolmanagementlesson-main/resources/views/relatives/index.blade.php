...
@section('content')
    ...
    <div id="createmodal" class="modal fade ">
                <div class="modal-dialog modal-dialog-centered ">
                    ...
                    <form id="{{route('relatives.store')}}" action="" method="POST">
                        {{ csrf_field() }}
                    ...
                    <form id="formaction" action="" method="POST">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-7 form-group">
                                ...
                                <input type="text" name="name" id="editname" class="form-control form-control-sm rounded-0" placeholder="Enter Day Name" value="{{old('name')}}" />
                            </div>
