                ...
                <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="image" id="image" class="form-control form-control-sm rounded-0" value="{{old('image',$post->image)}}" hidden />
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="time" name="starttime" id="starttime" class="form-control form-control-sm rounded-0" value="{{old('starttime',$post->starttime)}}" />
                                {{-- @error('starttime')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror --}}
                        </div>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="time" name="endtime" id="endtime" class="form-control form-control-sm rounded-0" value="{{old('endtime',$post->endtime)}}" />
                                {{-- @error('endtime')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror --}}
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="form-check form-switch mx-3">
                                    <input type="checkbox" name="day_id[]" id="day_id{{$idx}}" class="form-check-input dayactions" value="{{old('day_id',$post->day_id)}}"
                            ...
                            <!-- start hidden field  -->
                                <input type="hidden" name="dayable_type" id="End Day Action" value="App\Models\Post" />
                            <!-- end hidden field  -->
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" placeholder="Enter Post Title" value="{{old('title',$post->title)}}" />
                                {{-- @error('title')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror --}}
                        </div>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="number" name="fee" id="fee" class="form-control form-control-sm rounded-0" placeholder="Class Fee" value="{{old('fee',$post->fee)}}" />
                                {{-- @error('fee')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror --}}
                        </div>
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <textarea name="content" id="content" class="form-control form-control-sm rounded-0" rows="5" placeholder="Say Something...">{{old('content',$post->content)}}</textarea>
                                {{-- @error('content')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror --}}
                        </div>
